  ...
  return (
    <main className="app-shell">
      <header className="page-header" style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1.5rem" }}>
        <div>
          <button className="back-link" onClick={() => navigate("/faculty")} style={{ background: "none", border: "none", color: "#1d4ed8", cursor: "pointer", fontSize: "0.85rem", fontWeight: "600", padding: 0, marginBottom: "0.5rem", display: "inline-flex", alignItems: "center", gap: "0.25rem" }}>
            ← Back to Faculty
          </button>
          <h2 style={{ margin: 0, fontSize: "1.5rem", color: "#0f172a" }}>Timetable Assignment</h2>
          <p style={{ margin: "0.25rem 0 0", color: "#64748b", fontSize: "0.9rem" }}>Schedule classes and resolve conflicts.</p>
        </div>
